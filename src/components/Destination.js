...
import image1 from  "../images/carina-2400x1200.jpeg"
    ...
    <main  className="destination   grid-container-xxxxxxxx   ff-barlow-reg text-white">
        ...
        <div className="flex">
                <div className= "image-container ">
                  <img className= "images" src={image1} alt= "Carina Nebula"></img>
                </div>
                     ...
                     <div className= "text-container">
                        ...
                        <article>
                            ...
                            <p className="text-azure sub-heading5 mb">Travel amonst mountains and valleys of "glittering stars". Relax in our
                                      ...
                                      located in the constellation Carina, in the Carina–Sagittarius 
